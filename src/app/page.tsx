      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="rounded-xl border-2 border-[#E8E9EA] bg-gradient-to-br from-white via-[#FEFEFE] to-[#FCFCFC] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur transition-all hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:border-[#F7DC6F]">
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-gradient-to-r from-[#FED7AA] to-[#FDBA74] shadow-[0_1px_3px_rgba(245,158,11,0.3)]"></div>
          ...
          <div className="rounded-xl border-2 border-[#E8E9EA] bg-gradient-to-br from-white via-[#FEFEFE] to-[#FCFCFC] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.04)] backdrop-blur transition-all hover:shadow-[0_8px_24px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:border-[#F7DC6F]">
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <div className="h-3 w-3 rounded-full bg-gradient-to-r from-[#BFDBFE] to-[#93C5FD] shadow-[0_1px_3px_rgba(59,130,246,0.3)]"></div>
        ...
        <div className="text-center py-12 hidden">
          <div className="mx-auto h-24 w-24 rounded-full bg-gradient-to-br from-[#F8F9FA] via-[#F5F6F7] to-[#F1F2F4] border-2 border-[#E8E9EA] flex items-center justify-center mb-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)]">
            <span className="text-3xl">📝</span>
          </div>
          <h3 className="text-xl font-semibold text-[#4A5568] mb-2">No projects yet</h3>
          <p className="text-[#6B7280] mb-6">Start building your first project and watch your ideas come to life.</p>
          <button className="rounded-lg bg-gradient-to-r from-[#FFF4C4] via-[#FFECB3] to-[#FFE0B2] border border-[#F7DC6F] px-6 py-3 text-[#8B7355] font-medium shadow-[0_2px_8px_rgba(247,220,111,0.3)] hover:from-[#FFF9E6] hover:via-[#FFF4C4] hover:to-[#FFECB3] hover:shadow-[0_4px_12px_rgba(247,220,111,0.4)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F7DC6F] transition-all transform hover:scale-[1.02]">
      ...
      <footer className="border-t border-[#E8E9EA] bg-gradient-to-r from-white/95 via-[#FEFEFE]/95 to-white/95 py-6 backdrop-blur shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 text-sm text-[#6B7280] sm:px-6 lg:px-8">
          ...
          <nav className="flex gap-4">
            <Link href="/legal/privacy" className="hover:text-[#D4A574] transition-colors">Privacy</Link>
            <Link href="/legal/terms" className="hover:text-[#D4A574] transition-colors">Terms</Link>
