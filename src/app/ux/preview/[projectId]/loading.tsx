        ...
        <Card>
          <CardHeader>
            <div className="animate-pulse space-y-3">
              <div className="h-8 bg-metal-silverLight rounded-xl w-1/2" />
          ...
          <CardContent>
            <div className="animate-pulse space-y-6">
              <div className="space-y-3">
                <div className="h-6 bg-metal-silverLight rounded-lg w-1/3" />
                <div className="h-48 bg-metal-silverLight rounded-xl" />
              </div>
              
              <div className="h-20 bg-metal-silverLight rounded-xl" />
            </div>
          </CardContent>
